...
A.
A restful api hosted at https://foo.bar/api/v1

B.
An OS framework exposing bindings to a language

C.
Interface for interacting with an app
...
C.
Interactions with 3rd party APIs and DBs
...
A.
Interceptor -> Router -> Middleware -> Controller

B.
Router -> Controller -> Middleware -> Interceptor

C.
Controller -> Router -> Middleware -> Interceptor

D.
Router -> Middleware -> Controller -> Interceptor
